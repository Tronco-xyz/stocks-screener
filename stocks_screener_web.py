...
# Ensure all RS ratings are between 0 and 100
for period in ["1W", "1M", "3Q"]:
    if period in performance_df.columns:
        performance_df[period] = rankdata(performance_df[period], method="average") / len(performance_df[period]) * 100
